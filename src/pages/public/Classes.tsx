...
const classesData = [
  ...
  },
  {
    ...
    description:
      'Bài tập cường độ cao giúp đốt cháy mỡ nhanh chóng. Bao gồm các bài tập đẩy, kéo, nhảy và chạy.',
    maxParticipants: 12,
  },
  {
    id: 3,
    ...
    description:
      'Tập trung vào phát triển cơ bụng, lưng và đai hông. Giúp cải thiện tư thế và giảm đau lưng.',
    maxParticipants: 15,
  },
  {
    id: 4,
    ...
    description:
      'Kết hợp nhảy và vận động toàn thân. Vui nhộn, năng động và hiệu quả để đốt cháy calo.',
    maxParticipants: 20,
  },
  {
    id: 5,
    ...
    image: '/trainer02.avif',
    description:
      'Phát triển sức mạnh và độ bền với các bài tập kháng lực. Sử dụng tạ, máy tập và trọng lượng cơ thể.',
    maxParticipants: 15,
  },
  {
    id: 6,
    ...
    image: '/trainer03.avif',
    description:
      'Kết hợp kỹ thuật võ thuật với cardio. Giúp rèn luyện sức mạnh, tốc độ và phản xạ.',
    maxParticipants: 18,
  },
  {
    id: 7,
    ...
    image: '/trainer01.avif',
    description:
      'Dành cho người có kinh nghiệm tập yoga. Tập trung vào các tư thế phức tạp và kỹ thuật thở nâng cao.',
    maxParticipants: 12,
  },
  {
    id: 8,
    ...
    image: '/trainer04.avif',
    description:
      'Tập luyện theo vòng với nhiều trạm khác nhau. Kết hợp cardio và sức mạnh để đốt cháy mỡ hiệu quả.',
    maxParticipants: 15,
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-6 text-xl text-gray-300">
              Khám phá đa dạng các lớp tập luyện do đội ngũ huấn luyện viên chuyên nghiệp của chúng
              tôi giảng dạy
            </p>
          </div>
        </div>
      ...
      <section className="bg-primary py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-white/90 max-w-3xl mx-auto">
            Đăng ký thành viên ngay hôm nay để tham gia các lớp học chất lượng cùng huấn luyện viên
            chuyên nghiệp.
          </p>
          <div className="mt-8">
            <Link
