...
const TrainerDetail = () => {
  ...
  const [selectedTab, setSelectedTab] = useState<'about' | 'schedule' | 'classes' | 'testimonials'>(
    'about'
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center py-16">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Huấn luyện viên bạn đang tìm kiếm không tồn tại hoặc đã bị xóa.
          </p>
            ...
            {selectedTab === 'about' && (
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  {trainer.name} có một phương pháp toàn diện để huấn luyện, kết hợp các bài tập
                  cường độ cao, kỹ thuật đúng và hướng dẫn dinh dưỡng để đạt được kết quả tối ưu.
                  Mỗi chương trình được cá nhân hóa để phù hợp với mục tiêu, khả năng và lịch trình
                  của từng khách hàng.
                </p>
                <p className="text-gray-700">
                  Dù bạn là người mới bắt đầu hay vận động viên có kinh nghiệm, {trainer.name} sẽ
                  làm việc với bạn để phát triển một kế hoạch giúp bạn đạt được mục tiêu của mình
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-2">
                      ...
                      {trainer.schedule.map((time: any, index: number) => (
                        <div key={index} className="flex p-3 border rounded-lg bg-white">
                          <div className="flex-1">
                            ...
                            <p
                              className={`text-sm ${time.hours === 'Nghỉ' ? 'text-red-500' : 'text-gray-500'}`}
                            >
                              {time.hours}
                            </p>
                          </div>
                  ...
                  <div className="space-y-4 text-gray-700">
                    <p>
                      <strong>Hủy lịch:</strong> Vui lòng hủy ít nhất 24 giờ trước buổi tập đã đặt
                      lịch để tránh bị tính phí.
                    </p>
                    <p>
                      <strong>Muộn giờ:</strong> Nếu bạn đến muộn, buổi tập của bạn vẫn sẽ kết thúc
                      theo lịch trình để không ảnh hưởng đến khách hàng tiếp theo.
                    </p>
                    <p>
                      <strong>Gói luyện tập:</strong> Các buổi tập phải được sử dụng trong vòng 60
                      ngày kể từ ngày mua.
                    </p>
                  </div>
                </div>
                ...
                {trainer.clients.length > 2 && (
                  <div className="mt-6 text-center">
                    ...
                    >
                      {showAllTestimonials
                        ? 'Hiển thị ít hơn'
                        : `Xem thêm ${trainer.clients.length - 2} nhận xét`}
                    </button>
                  </div>
                )}
              </div>
