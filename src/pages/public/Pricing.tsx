      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-dark to-gray-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">Bảng giá thành viên</h1>
            <p className="mt-6 text-xl text-gray-300">
              Chọn gói phù hợp với nhu cầu và mục tiêu của bạn. Tất cả các gói đều bao gồm các tiện ích cơ bản và sự hỗ
              trợ từ đội ngũ FitHub Pro.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="mt-12 space-y-4 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:grid-cols-3">
            ...
            <div className="border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-200 bg-white">
              <div className="p-6">
                ...
                <p className="mt-2 text-sm text-gray-500">Lựa chọn hoàn hảo cho những ai mới bắt đầu</p>
                <p className="mt-4">
                  <span className="text-4xl font-extrabold text-gray-900">
                    {getPrice(49, billingCycle).toLocaleString("vi-VN")}
                  </span>
                  <span className="text-base font-medium text-gray-500">/{getCycleText(billingCycle)}</span>
                </p>
                <Link
                  to="/login"
              ...
              <div className="px-6 pt-6 pb-8">
                <h3 className="text-sm font-semibold text-gray-900 tracking-wide uppercase">Bao gồm</h3>
                  ...
                  {basicFeatures.map((feature, index) => (
                    <li key={index} className="flex">
                      ...
                      <span className={`ml-3 text-sm ${feature.included ? "text-gray-700" : "text-gray-400"}`}>
                        {feature.title}{" "}
                        {feature.value && feature.included && <span className="font-semibold">({feature.value})</span>}
                      </span>
                    </li>
                  ))}
                </ul>
                  ...
                  {standardFeatures.map((feature, index) => (
                    <li key={index} className="flex">
                      ...
                      <span className="ml-3 text-sm text-gray-700">
                        {feature.title} {feature.value && <span className="font-semibold">({feature.value})</span>}
                      </span>
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto divide-y-2 divide-gray-200">
            <h2 className="text-center text-3xl font-extrabold text-gray-900 sm:text-4xl">Câu hỏi thường gặp</h2>
            <dl className="mt-6 space-y-6 divide-y divide-gray-200">
              <div className="pt-6">
                <dt className="text-lg font-medium text-gray-900">Có cần thanh toán phí đăng ký ban đầu không?</dt>
                <dd className="mt-2 text-base text-gray-500">
                  Không, bạn chỉ cần thanh toán theo kỳ hạn đã chọn mà không cần phí đăng ký ban đầu.
                </dd>
              </div>
              <div className="pt-6">
                <dt className="text-lg font-medium text-gray-900">Tôi có thể hủy hoặc đổi gói thành viên không?</dt>
                <dd className="mt-2 text-base text-gray-500">
                  Có, bạn có thể hủy hoặc thay đổi gói thành viên vào cuối mỗi kỳ thanh toán. Nếu nâng cấp gói, phần
                  chênh lệch sẽ được tính theo thời gian còn lại.
                </dd>
              </div>
              <div className="pt-6">
                <dt className="text-lg font-medium text-gray-900">Buổi huấn luyện cá nhân kéo dài bao lâu?</dt>
                <dd className="mt-2 text-base text-gray-500">
                  Mỗi buổi huấn luyện cá nhân kéo dài 60 phút với huấn luyện viên chuyên nghiệp.
                </dd>
              </div>
              <div className="pt-6">
                <dt className="text-lg font-medium text-gray-900">Tôi có thể mang theo bạn đến phòng tập không?</dt>
                <dd className="mt-2 text-base text-gray-500">
                  Các gói Tiêu Chuẩn và Cao Cấp cho phép bạn mang khách với số lượng hạn chế mỗi tháng. Khách đi cùng
                  cần đăng ký trước và tuân thủ nội quy phòng tập.
                </dd>
              </div>
              <div className="pt-6">
                <dt className="text-lg font-medium text-gray-900">Phương thức thanh toán nào được chấp nhận?</dt>
                <dd className="mt-2 text-base text-gray-500">
                  Chúng tôi chấp nhận thanh toán qua thẻ tín dụng, thẻ ghi nợ, chuyển khoản ngân hàng và các ví điện tử
                  phổ biến như MoMo, ZaloPay, và VNPay.
                </dd>
              </div>
            </dl>
          </div>
