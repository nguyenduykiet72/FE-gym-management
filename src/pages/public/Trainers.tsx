    ...
    <div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-dark to-gray-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">Đội ngũ huấn luyện viên</h1>
            <p className="mt-6 text-xl text-gray-300">
              Tập luyện cùng các huấn luyện viên chuyên nghiệp với nhiều năm kinh nghiệm trong các lĩnh vực fitness khác
              nhau
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="mb-4 md:mb-0">
              <h2 className="text-lg font-medium text-gray-900 mb-1">Tìm huấn luyện viên phù hợp</h2>
              <p className="text-sm text-gray-500">{filteredTrainers.length} huấn luyện viên được tìm thấy</p>
            </div>
              ...
              <div key={trainer.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    <Link to={`/trainers/${trainer.id}`} className="text-primary hover:text-primary/80 font-medium">
                      Xem chi tiết
                    </Link>
                    <Link
                      to="/login"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="mt-2 text-gray-600">
                Dựa trên chuyên môn, lịch trình và đánh giá để chọn huấn luyện viên phù hợp với nhu cầu của bạn.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="mt-2 text-gray-600">
                Đăng nhập tài khoản và chọn ngày, giờ phù hợp với bạn trong lịch trình của huấn luyện viên.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="mt-2 text-gray-600">
                Đến đúng giờ và tận hưởng buổi tập chất lượng với huấn luyện viên chuyên nghiệp của chúng tôi.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-primary py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white">Sẵn sàng bắt đầu hành trình fitness?</h2>
